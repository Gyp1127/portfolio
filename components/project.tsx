...
export default function Project({
    ...
    return (
        <motion.div ref={ref} 
            ...
            <section 
            className="bg-stone-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] group-even:pl-8 hover:bg-stone-200 transition rounded-lg">
                ...
                shadow-2xl group-even:-right-[initial] group-even:-left-40 group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-[1.04]  transition
